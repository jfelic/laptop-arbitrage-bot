...
exports.constructEbayQuery = constructEbayQuery;
exports.valuateDeal = valuateDeal;
 ...
 */
function constructEbayQuery(title) {
 ...
 */
async function getEbaySoldPrices(query) {
 ...
 */
async function valuateDeal(title, currentPrice) {
    try {
